    ...
    <>
      ...
      <div className="border-b bg-white">
        <div className="container mx-auto px-4 py-4">
          ...
          <button className="mt-3 flex items-center gap-2 text-sm text-[#558DCA] hover:text-[#7B91FF]">
                  ...
                  <div className="flex items-center gap-6">
                    ...
                    <div className="flex flex-1 items-center gap-4">
                      <div>
                        ...
                        <div className="text-xs text-[#022444]">2 дек, вт</div>
                      </div>
                      ...
                      <div>
                        ...
                        <div className="text-sm text-[#022444]">Олекминск</div>
                        <div className="text-xs text-[#022444]">3 дек, ср</div>
                      </div>
                    </div>
                  </div>
                </div>
