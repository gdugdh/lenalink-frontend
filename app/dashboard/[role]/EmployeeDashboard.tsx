...
import { LogOut, Briefcase, Calendar, FileText, Ticket, Home } from 'lucide-react';
      ...
      <div className="container mx-auto p-4 sm:p-6 space-y-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <Card>
            ...
            <CardContent>
              <div className="text-3xl font-bold text-primary">{pendingApprovals}</div>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-3xl font-bold text-primary">{activeTrips}</div>
            </CardContent>
          </Card>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Чеки и отчеты</CardDescription>
            </CardHeader>
            <CardContent>
              <Button variant="outline" size="sm" className="w-full">
                Открыть
