              ...
              <div className="space-y-4">
                  ...
                  <div className="flex-1">
                    <div className="flex items-center justify-between">
                      ...
                      <div className="text-center">
                        <div className="text-xs text-[#022444]">10 ч 30 мин</div>
                ...
                <div className="flex items-start gap-4 pb-4">
                  <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-full bg-[#96FFFF]">
                    <svg className="h-6 w-6 text-[#022444]" viewBox="0 0 24 24" fill="currentColor">
                  ...
                  <div className="flex-1">
                    <div className="flex items-center justify-between">
                      ...
                      <div className="text-center">
                        ...
                        <div className="my-2 h-px w-24 bg-[#96FFFF]"></div>
                        <div className="text-xs font-medium text-[#022444]">
          ...
          <div className="space-y-6">
            ...
            <div className="rounded-lg border bg-white p-6">
              ...
              <div className="flex justify-between">
                ...
                <span className="text-2xl font-bold text-[#7B91FF]">41 256₽</span>
              </div>
